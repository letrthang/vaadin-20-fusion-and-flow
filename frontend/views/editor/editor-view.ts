...
export class EditorView extends View {
  ...
  connectedCallback() {
    ...
    this.rteValue = JSON.stringify([
      { insert: 'High quality rich text editor for the web' },
      { attributes: { header: 2 }, insert: '\n' },
      { insert: '<vaadin-rich-text-editor> is a Web Component providing rich text editor functionality, part of the ' },
      { attributes: { link: 'https://vaadin.com/components' }, insert: 'Vaadin components' },
      ...
      { insert: 'script and ' },
      { attributes: { script: 'super' }, insert: 'super' },
      { insert: 'script' },
      { attributes: { list: 'bullet' }, insert: '\n' },
      { attributes: { link: 'https://vaadin.com' }, insert: 'Hyperlink' },
      { attributes: { list: 'bullet' }, insert: '\n' },
